    ...
    <div class="py-6">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('dispositivos.store') }}" class="space-y-4">
                    @csrf
                    ...
                    <div>
                        ...
                        <x-text-input id="tipo_dispositivo" name="tipo_dispositivo" type="text" class="mt-1 block w-full" :value="old('tipo_dispositivo')" placeholder="ESP32, PLC, Gateway..." />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <x-text-input id="direccion_ip" name="direccion_ip" type="text" class="mt-1 block w-full" :value="old('direccion_ip')" placeholder="192.168.0.10" />
                            <x-input-error :messages="$errors->get('direccion_ip')" class="mt-2" />
                        </div>

                        <div>
                            <x-input-label for="puerto" value="Puerto" />
                            <x-text-input id="puerto" name="puerto" type="number" class="mt-1 block w-full" :value="old('puerto')" />
                    ...
                    <div>
                        ...
                        <x-text-input id="mac_address" name="mac_address" type="text" class="mt-1 block w-full" :value="old('mac_address')" />
                        <x-input-error :messages="$errors->get('mac_address')" class="mt-2" />
                    </div>

                    <div>
                        <x-input-label for="firmware" value="Versión de Firmware" />
                        <x-text-input id="firmware" name="firmware" type="text" class="mt-1 block w-full" :value="old('firmware')" />
                    ...
                    <div class="flex items-center gap-4">
                        <x-primary-button>Guardar Dispositivo</x-primary-button>
